#!/usr/bin/env node
/**
 * new-policy-area.js — Scaffold a new policy area HTML page from the canonical template.
 *
 * Usage:
 *   node scripts/new-policy-area.js \
 *     --id my-policy-area-name \
 *     --title "My Policy Area Title" \
 *     --foundation freedom-to-thrive \
 *     --color "#1a6b8a" \
 *     --prefix "MPL"
 *
 * The script writes docs/policy/<id>.html and prints next steps.
 * After generating, register the policy area in docs/assets/js/data.js.
 */
...
// src/pages/policy/<id>.njk (a content-block .njk, not full HTML) and call
...
const outputDir = path.resolve(__dirname, '../docs/policy');
...
<!-- Per-policy-area accent color — only this block should remain inline -->
...
<nav class="site-nav">
  <div class="nav-inner">
    ...
    <ul class="nav-links">
      ...
      <li><a href="index.html" class="active">Policy Areas</a></li>
      <li><a href="../compare/index.html">Perspectives</a></li>
    </ul>
  </div>
</nav>

<!-- ═══ POLICY AREA SECTION NAV ═══ -->
<nav class="area-snav" id="area-snav">
  <ul>
    <li><a href="#area-intro">Overview</a></li>
    <li><a href="#area-problem">The Problem</a></li>
    <li><a href="#area-reform">Reform Areas</a></li>
    <li><a href="#area-policy">Policy Positions</a></li>
    <li><a href="#area-research">Research</a></li>
    <li><a href="#area-refs">References</a></li>
    <li><a href="#area-related">Related</a></li>
  </ul>
</nav>
...
<div class="page-hero on-dark" style="background:var(--navy);padding:3rem 0 2.5rem;">
  <div class="wrap">
    ...
    <p class="hero-statement" style="font-size:1rem;max-width:680px;margin:0 auto">
      <!-- TODO: one-sentence mission statement for this policy area -->
    </p>
  </div>
</div>

<!-- ═══ INTRO ═══ -->
<section class="bg-parchment" id="area-intro">
  <div class="wrap">
    ...
    <div class="area-intro">
      ...
      <div>
        <h2>What This Policy Area Covers</h2>
        <ul>
          <!-- TODO: scope list -->
        </ul>
      </div>
...
<!-- ═══ PROBLEM ═══ -->
<section class="bg-dark on-dark" id="area-problem">
  <div class="wrap">
...
<!-- ═══ REFORM ═══ -->
<section class="bg-parchment" id="area-reform">
  <div class="wrap">
...
<!-- ═══ POLICY ═══ -->
<section class="bg-white" id="area-policy">
  <div class="wrap">
...
<!-- ═══ RESEARCH ═══ -->
<section class="bg-dark on-dark" id="area-research">
  <div class="wrap">
...
<!-- ═══ REFERENCES ═══ -->
<section class="bg-parchment footnotes" id="area-refs">
  <div class="wrap">
    <h2>References</h2>
...
<!-- ═══ RELATED ═══ -->
<section class="bg-navy on-dark" id="area-related">
  <div class="wrap" style="text-align:center">
    <p class="eyebrow">Connected Policy Areas</p>
    ...
    <div style="display:flex;flex-wrap:wrap;gap:1rem;justify-content:center;margin-top:1.5rem">
      <!-- Add links to related policy areas here -->
    </div>
...
<footer class="site-footer">
  <div class="wrap">
    ...
    <ul class="footer-links">
      <li><a href="../index.html">Home</a></li>
      <li><a href="../foundations.html">Foundations</a></li>
      <li><a href="index.html">Policy Areas</a></li>
      <li><a href="../compare/index.html">Perspectives</a></li>
    </ul>
...
console.log(`  1. Add policy area to docs/assets/js/data.js — policyAreas array + foundation "${foundation}" .policy areas list`);
console.log(`  2. Update POLICY_AREA_COUNT in tests/unit/data.test.js and tests/e2e/site.spec.js`);
